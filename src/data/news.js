export const newsList = [
  {
    id: 'huong-dan-thi-cong-lop-mai',
    title: 'Hướng Dẫn Thi Công Lợp Mái Đá Slate Lai Châu Đúng Kỹ Thuật',
    ...
    content: [
      ...
      'Bước 2: Lựa chọn đúng quy cách đá Slate (Đá Slate hình chữ nhật, vảy cá, lục giác...)',
      'Bước 3: Lợp đá theo nguyên tắc chồng mí (Lợp từ dưới lên trên, từ mép vào tâm...)',
      'Bước 4: Cố định từng viên đá chắc chắn',
      'Bước 5: Hoàn thiện các chi tiết kỹ thuật'
    ]
  },
  {
    id: 'uu-diem-da-den-lai-chau',
    title: 'Ưu điểm vượt trội của đá đen Lai Châu trong kiến trúc hiện đại',
    ...
    content: [
      ...
      'Thứ hai, độ bền màu vĩnh cửu. Đá không chứa thành phần canxi cacbonat nên không bị ăn mòn bởi axit có trong nước mưa. Dù trải qua hàng trăm năm chịu nắng mưa, màu đen ghi thâm trầm sang trọng của đá vẫn giữ nguyên vẹn.',
      'Thứ ba, khả năng cách nhiệt tuyệt hảo. Nhờ thớ đá xếp lớp, mái đá hoặc sàn đá Lai Châu hoạt động như một lớp cách nhiệt tự nhiên, giúp điều hòa nhiệt độ trong nhà luôn mát mẻ vào mùa hè và ấm áp vào mùa đông.',
      'Thứ tư, tính thẩm mỹ độc bản. Bề mặt chẻ tay thủ công tạo nên những đường vân gồ ghề ngẫu hứng, mộc mạc nhưng cực kỳ sang trọng dưới ánh sáng đèn hắt trang trí.'
    ]
  },
  {
    id: 'quy-trinh-khai-thac-che-tac',
    title: 'Quy trình khai thác và chế tác đá Slate tại mỏ đá Lai Châu',
    category: 'Vận hành mỏ',
    date: '2026-06-05',
    ...
    content: [
      ...
      'Giai đoạn 2: Vận chuyển và hạ tải khối đá về xưởng chế tác gần mỏ. Tại đây, các khối đá lớn được cắt thành các block nhỏ hơn theo kích thước quy chuẩn bằng máy cắt đĩa lớn.',
      'Giai đoạn 3: Chẻ đá thủ công. Đây là khâu quan trọng nhất và hoàn toàn không thể thay thế bằng máy móc. Các nghệ nhân chẻ đá sẽ dùng đục sắt và búa gõ nhẹ vào các thớ đá tự nhiên để tách khối đá thành những tấm mỏng (từ 4-7mm cho ngói lợp mái, 10-20mm cho đá ốp lát).',
      'Giai đoạn 4: Cắt định hình và kiểm định chất lượng. Các tấm đá sau khi chẻ sẽ được cắt vuông vức hoặc bo góc vảy cá theo kích thước yêu cầu. Đội ngũ KCS kiểm định nghiêm ngặt độ dày, bề mặt phẳng và loại bỏ những tấm rạn nứt trước khi đóng kiện gỗ xuất xưởng.'
    ]
  },
  {
    id: 'da-da-sac-mat-tien-biet-thu',
    title: 'Đá đa sắc Lai Châu - Điểm nhấn độc bản cho mặt tiền biệt thự',
    category: 'Ý tưởng thiết kế',
    date: '2026-05-28',
    ...
    content: [
      ...
      'Khi ốp lên mặt tiền, những mảng màu tương phản nhẹ nhàng kết hợp với bề mặt chẻ thô lồi lõm tạo nên một tác phẩm nghệ thuật 3D sống động. Dưới các góc chiếu sáng khác nhau của ánh mặt trời từ sáng đến chiều, màu sắc bức tường đá sẽ biến đổi kỳ ảo, mang lại diện mạo luôn mới mẻ cho ngôi nhà.',
      'Không chỉ đẹp, độ cứng bề mặt cao và khả năng chống chịu axit giúp bức tường đá đa sắc không bị ố bẩn, rêu mốc hay bay màu dưới tác động khắc nghiệt của thời tiết ngoài trời, bảo vệ kết cấu tường bên trong luôn khô ráo.'
    ]
  },
  {
    id: 'bao-duong-ve-sinh-san-vuon',
    title: 'Cẩm nang bảo dưỡng và vệ sinh sân vườn lát đá tự nhiên',
    ...
    content: [
      ...
      '2. Rửa sân bằng vòi nước áp lực cao: Định kỳ 3-6 tháng, bạn nên dùng máy phun nước áp lực cao (áp lực vừa phải) để thổi bay các vết bùn đất bám sâu trong các kẽ đá và mạch vữa chèn cỏ.',
      '3. Loại bỏ vết ố cứng đầu: Với các vết ố do dầu mỡ thức ăn ngoài trời hoặc rỉ sét sắt, bạn có thể dùng nước rửa chén pha loãng kết hợp bàn chải chà nhẹ. Tuyệt đối không dùng chất tẩy rửa có nồng độ axit mạnh (như axit HCl vệ sinh xây dựng) vì có thể làm biến đổi khoáng chất tự nhiên trong đá đa sắc.',
      '4. Chăm sóc mạch cỏ: Nếu bạn lát đá xếp lối đi xen cỏ, hãy cắt tỉa cỏ định kỳ để giữ lối đi thông thoáng, làm nổi bật những viên đá chẻ tự nhiên mộc mạc.'
    ]
  }
];
